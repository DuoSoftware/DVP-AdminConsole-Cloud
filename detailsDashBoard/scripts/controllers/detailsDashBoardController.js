            ...
            gridApi.selection.on.rowSelectionChanged($scope, function (row) {
                ...
                if (row.isSelected) {
                    ...
                    var AInfoPanelSetup = $interval(function () {
                        var selectedAgentRowPos = angular.element('.ui-grid-row-selected').offset();
                        var selectedAgentChartPos = angular.element('.agentSummery').offset();
    ...
    $scope.getAgentStatusList = function (selectedAgent, element) {
        ...
        try {
            cdrApiHandler.getAgentStatusRecords(startDate, endDate, [], agentFilter).then(function (agentListResp) {
                ...
                gearaltGanttChartData(agentListResp.Result[Object.keys(agentListResp.Result)[0]], element);
